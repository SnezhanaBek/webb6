...
<body>
<div class="container">
    <h1>Регистрационная анкета — Задание 6</h1>
    ...
    <?php if ($generatedLogin && $generatedPass): ?>
        <div class="credentials-box">
            ...
            Логин: <strong><?php echo htmlspecialchars($generatedLogin); ?></strong><br>
            Пароль: <strong><?php echo htmlspecialchars($generatedPass); ?></strong><br>
    ...
    <p style="margin-top: 20px;"><a href="admin.php">🔐 Админ-панель</a></p>
</div>
</body>
</html>